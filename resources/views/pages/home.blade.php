    ...
    <div class="container-fluid page-container main-body-container">
        ...
        <div class="page-header-breadcrumb mb-3">
            <div class="d-flex align-center justify-content-between flex-wrap">
                <h1 class="page-title fw-medium fs-18 mb-0">Meteo</h1>
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item"><a href="javascript:void(0);">Dashboards</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Meteo</li>
                </ol>
            </div>
        </div>
        <!-- End::page-header -->
                        ...
                        <ul class="list-group list-group-flush">
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    <div class="lh-1">
                                                <span class="avatar avatar-md avatar-rounded bg-light">
                                                    <img src="/assets/images/faces/doctors/1.png" alt="">
                                                </span>
                                    </div>
                                    <div class="flex-fill">
                                        <span class="d-block fw-semibold">Dr. John Miller</span>
                            ...
                            <li class="list-group-item">
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    <div class="lh-1">
                                                <span class="avatar avatar-md avatar-rounded bg-light">
                                                    <img src="/assets/images/faces/doctors/4.png" alt="">
                                                </span>
                                    </div>
                                    <div class="flex-fill">
                                        <span class="d-block fw-semibold">Dr. Sarah Williams</span>
                            ...
                            <li class="list-group-item">
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    <div class="lh-1">
                                                <span class="avatar avatar-md avatar-rounded bg-light">
                                                    <img src="/assets/images/faces/doctors/2.png" alt="">
                                                </span>
                                    </div>
                                    <div class="flex-fill">
                                        <span class="d-block fw-semibold">Dr. Mark Thompson</span>
                            ...
                            <li class="list-group-item">
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    <div class="lh-1">
                                                <span class="avatar avatar-md avatar-rounded bg-light">
                                                    <img src="/assets/images/faces/doctors/5.png" alt="">
                                                </span>
                                    </div>
                                    <div class="flex-fill">
                                        <span class="d-block fw-semibold">Dr. Emily Davis</span>
                            ...
                            <li class="list-group-item">
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    <div class="lh-1">
                                                <span class="avatar avatar-md avatar-rounded bg-light">
                                                    <img src="/assets/images/faces/doctors/3.png" alt="">
                                                </span>
                                    </div>
                                    <div class="flex-fill">
                                        <span class="d-block fw-semibold">Dr. James Clark</span>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <div class="lh-1">
                                                            <span class="avatar avatar-sm avatar-rounded bg-light">
                                                                <img src="/assets/images/faces/doctors/6.png" alt="">
                                                            </span>
                                            </div>
                                            <div>
                                                Dr. Martinez
